...
sonnet35 = (
    pd.read_feather("tempdata/llm_extractions/anthropic-claude-3.5-sonnet_20240926_140907.intermediate.feather")
    .rename(columns={"llm_is_open_data":"sonnet35_is_open_data"})
    [["filename","sonnet35_is_open_data"]]
)
df = (
    pd.read_feather("tempdata/llm_extractions/openai-gpt-4o-mini_20240926_120539.feather")
